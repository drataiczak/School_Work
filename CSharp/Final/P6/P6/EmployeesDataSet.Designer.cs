...
namespace P6 {
    ...
    public partial class EmployeesDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow AddEmployeesRow(string Name, string DOB, string UserID, string Password, string Cell, string Salary) {
...
namespace P6.EmployeesDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Employees` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `DOB` IS NULL) OR (`DOB` = ?)) AND ((? = 1 AND `UserID` IS NULL) OR (`UserID` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Cell` IS NULL) OR (`Cell` = ?)) AND ((? = 1 AND `Salary` IS NULL) OR (`Salary` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employees` (`Name`, `DOB`, `UserID`, `Password`, `Cell`, `Salary`) V" +
                "ALUES (?, ?, ?, ?, ?, ?)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, DOB, UserID, [Password], Cell, Salary FROM Employees";
